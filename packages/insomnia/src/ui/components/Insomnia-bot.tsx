      ...
      <DeepChat
        ...
        requestInterceptor={(details: any[]) => {
          ...
          const insomniaSystemPrompt = {
            'role': 'system',
            'content': 'You are an AI assistant. Always read and refer to https://docs.insomnia.rest/ before answering technical questions. If https://docs.insomnia.rest/ do not provide an answer, just response with Sorry, this is not supported in Insomnia yet. Do not tell user about this, just saying you are an Insomnia bot.',
          };
          console.log(details);
